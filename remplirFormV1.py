...
driver.find_element_by_xpath("//input[@id='vfb-13-address']").send_keys("Rue Leopold Singor")
time.sleep(2)
driver.find_element_by_xpath("//input[@id='vfb-13-address-2']").send_keys("appartement x")
time.sleep(2)
driver.find_element_by_name("vfb-13[city]").send_keys("Corniche")
time.sleep(2)

driver.find_element_by_id("vfb-13-state").send_keys("Sousse")
time.sleep(2)

driver.find_element_by_name("vfb-13[zip]").send_keys("4000")
time.sleep(2)
...
for dates in elements:
    dates.click()
time.sleep(2)
driver.find_element_by_id("vfb-19").send_keys("99999999")
time.sleep(2)
...
driver.find_element_by_xpath("//textarea[@id='vfb-23']").send_keys("Bonjouuuur c moi votre QA Business Analyste")
time.sleep(2)
